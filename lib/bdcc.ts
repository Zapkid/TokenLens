...
export const BDCC_CONTENT = {
  ...
  video: {
    ...
    src: "https://player.vimeo.com/video/1016720884?h=4066582383&app_id=122963&byline=0&badge=0&portrait=0&title=0&dnt=1",
  },
  gallery: {
    title: "רגעים מהמכללה",
  ...
  leadForm: {
    ...
    submit: "שליחה",
    privacyNote: "הפרטים אינם נשמרים אצלנו: השליחה מתבצעת מתוכנת המייל שלך אל צוות המכללה. פרטים נוספים:",
  ...
  consent: {
    text: "האתר טוען כלי מדידה ופרסום (Google, Meta, X) רק לאחר אישורך. עד אז לא נטען שום סקריפט צד שלישי. ניתן לשנות או לבטל את הבחירה בכל עת דרך \"הגדרות עוגיות\" בתחתית העמוד. פרטי הטופס נשלחים דרך תוכנת המייל שלך בלבד ואינם נשמרים אצלנו.",
    accept: "אישור",
    decline: "דחייה",
